        ...
        <div>
            {
                cart.map(product => (
                    <div className="d-flex detail-product" key={product.product_id}>
                        <img src={product.image.url} alt="" className="detail-product__image" />
                        <div className="detail-product__info">
                            ...
                            <h6 className="text-danger detail-product__info__price">${product.price * product.quantity}</h6>
                            <h6 className="detail-product__info__description">{product.description}</h6>
                            <h6 className="detail-product__info__sold">Sold: {product.sold}</h6>
